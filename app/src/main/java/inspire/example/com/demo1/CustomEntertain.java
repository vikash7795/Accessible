 ...
 */
public class CustomEntertain extends ArrayAdapter<String> {
    ...
    public CustomEntertain(Activity context,
                           String[] web, Integer[] imageId,String[] location,String[] distance,String[] accessibility) {
        super(context, R.layout.list_entertain, web);
    ...
    public View getView(int position, View view, ViewGroup parentView) {
        ...
        View rowView= inflater.inflate(R.layout.list_entertain,null,true);
